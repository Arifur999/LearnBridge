...
import { Star, BookOpen, CheckCircle, ArrowLeft } from "lucide-react";
...
export default async function CourseDetailsPage({
  ...
  if (!tutor) {
    return (
      <div className="mx-auto max-w-7xl px-4 py-20 text-center">
        ...
        <p className="text-muted-foreground">Could not find course with ID: {id}</p>
      </div>
    );
  }
  ...
  return (
    <>
      {/* Hero banner */}
      <div className="relative isolate overflow-hidden border-b bg-slate-950 text-white">
        <div className="absolute inset-0 bg-linear-to-r from-amber-900/25 via-slate-950/90 to-slate-950" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 md:py-16">
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end">
            {/* Icon / avatar */}
            <div className="flex size-28 shrink-0 items-center justify-center rounded-2xl bg-amber-900/30 text-3xl font-bold text-amber-200 ring-4 ring-white/10">
              {initials}
            </div>
            ...
            <div className="flex-1">
              {tutor.category && (
                <span className="mb-2 inline-block rounded-full bg-amber-400/20 px-3 py-0.5 text-xs font-semibold uppercase tracking-[0.15em] text-amber-300 ring-1 ring-amber-400/30">
                  {tutor.category}
                </span>
              )}
            ...
            {tutor.price != null && (
              <div className="shrink-0 rounded-2xl bg-white/10 px-5 py-3 text-center ring-1 ring-white/15 backdrop-blur-sm">
                <p className="text-2xl font-black">BDT {tutor.price}</p>
        ...
        <div className="grid gap-10 lg:grid-cols-3">
          ...
          <div className="space-y-8 lg:col-span-2">
            ...
            <div className="rounded-2xl border bg-muted/30 p-6">
              <h3 className="mb-3 font-semibold">About this course</h3>
